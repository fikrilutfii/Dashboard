<aside class="w-64 bg-gray-900 text-white min-h-screen flex flex-col transition-all duration-300" :class="{ '-ml-64': !open }">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('reports.stock') }}" class="flex items-center px-6 py-2 transition-all duration-200 hover:bg-gray-800 hover:text-white {{ request()->routeIs('reports.stock') ? 'text-white bg-gray-800 border-l-4 border-primary-500' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3 text-gray-400">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                    </svg>
                    <span>Dashboard Stok Barang</span>
                </a>
            </li>
            <li>
