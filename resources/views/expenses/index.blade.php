                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    @if(Auth::user()->isAdmin())
                                        <form action="{{ route('expenses.destroy', $expense) }}" method="POST" class="action-confirm inline" data-title="Apakah Anda yakin?" data-text="Hapus data pengeluaran ini secara permanen? Data transaksi & keuangan akan ikut terhapus." data-icon="warning" data-confirm-text="Ya, Hapus!" data-confirm-color="#ef4444">
                                            @csrf @method('DELETE')
