<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-zinc-100 shadow-sm overflow-hidden">
            <form action="{{ route('payrolls.storeRecap') }}" method="POST" class="action-confirm" data-title="Konfirmasi Proses" data-text="Proses pembayaran mingguan ini? Status akan menjadi Belum Lunas." data-icon="question" data-confirm-text="Ya, Proses" data-confirm-color="#3b82f6">
                @csrf
